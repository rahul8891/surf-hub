                            ...
                            <div class="ratingShareWrap">
                                ...
                                <div>
                                    <ul class="pl-0 mb-0 d-flex">
                                        ...
                                        <li>
                                            <a target="_blank" href="http://www.facebook.com/sharer.php?s=100&amp;p[title]=<?php echo ($posts->post_text); ?>&amp;p[image][0]=<?php echo (asset('storage/images/'.$posts->upload['image'])); ?>,'share'">
