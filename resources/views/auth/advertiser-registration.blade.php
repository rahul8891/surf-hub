...
<form method="POST" id="register" name="register-advertiser" action="{{ route('register') }}"
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <input type="tel" id="phoneadvertiser" class="form-control" placeholder="Phone" name="phone" value="{{ old('phone') }}" minlength="8" maxlength="15" autocomplete="phone" required>
            @error('phone')
            <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
