                ...
                <div class="post">
                    ...
                    <div class="inner">
                        ...
                        <div class="imgRatingWrap">
                            ...
                            <br>
                            <div class="pos-rel editBtnWrap">
                                <video width="100%" controls autoplay playsinline playsinline="playsinline" muted class=" img-fluid" id="myImage{{$posts->id}}"><source src="{{ asset('storage/videos/'.$posts->upload->video) }}"></video>
