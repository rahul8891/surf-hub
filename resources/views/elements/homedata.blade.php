                ...
                <div class="inner-news-feed">
                    <div class="user-details">
                        ...
                        @if($posts->user_id != Auth::user()->id)
                            <div class="user-right">
                                ...
                                <button class="follow-btn follow <?php echo (isset($posts->followPost->id) && !empty($posts->followPost->id)) ? ((($posts->followPost->status == 'FOLLOW') && ($posts->followPost->follower_request_status == '0')) ? 'clicked' : 'clicked Follow') : 'followPost' ?>" data-id="{{ $posts->user_id }}" data-post_id="{{ $posts->id }}"><span class="follow-icon"></span> FOLLOW</button>
                            </div>
                        @endif
                    </div>
                    @if(!empty($posts->upload->image))
                        <div class="newsFeedImgVideo">
                            <img src="{{ env('IMAGE_FILE_CLOUD_PATH').'images/'.$posts->user->id.'/'.$posts->upload->image }}" alt="" class="">
                        </div>
                    ...
                    <div class="user-bottom-options">
                        ...
                        <div class="right-options">
                            ...
                            <a onclick="openFullscreen({{$posts->id}}, 'feed');"><img src={{asset("img/expand.png")}} alt="Expand"></a>
                            ...
                            <div class="d-inline-block tag dropdown" title="Tag">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    @endif
                                    <div>
                                        <input type="text" autofocus name="tag_user" placeholder="@ Search user" class="form-control ps-2 tag_user" required data-post_id="{{$posts->id}}">
                                        <input type="hidden" value="{{ old('user_id')}}" name="user_id" id="user_id" class="form-control user_id">
