        ...
        <div class="user-details">
            <div class="user-left">
                ...
                <div>                                                            
                    ...
                    <p class="address">{{ (isset($posts->beach_breaks->beach_name))?$posts->beach_breaks->beach_name:'' }} {{ (isset($posts->break_name->break_name))?$posts->beach_name->beach_name:'' }}, {{\Carbon\Carbon::parse($posts->surf_start_date)->format('d-m-Y') }}</p>
