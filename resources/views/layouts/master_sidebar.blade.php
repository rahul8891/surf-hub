<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('adminIndex')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-light">{{ucwords(Auth::user()->user_profiles->first_name.' '.Auth::user()->user_profiles->last_name)}}</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">        
          ...
          <li class="nav-item has-treeview {{ menuOpen('users') }}">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('adminUserListIndex')}}" class="nav-link {{ activeMenu('adminUserListIndex') }}">
