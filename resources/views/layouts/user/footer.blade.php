		...
		jQuery.ajax({
		    ...
		    success: function(result) {
		        if(result.data.is_highlight == "1") {
		            // that.addClass('blue');
                    jQuery('#'+postID+' .highlight.highlightPost ').addClass('blue');
                    ...
                    jQuery('#'+postID+' .highlight.highlightPost ').removeClass('blue');
                    jQuery("main").prepend('<div class="alert alert-success alert-dismissible" role="alert" id="msg-alert"><button type="button" class="close btn-primary" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>Post has been removed to your Highlights Reel.</div>');
		        }
		    }
		});
	});
