                            ...
                            <div class="col-md-5">
                                ...
                                <div class="filter-checkbox start-rating mb-4">
                                    ...
                                    <div class="start-rating-inner">
                                        <input id="filter-rating" type="hidden" name="rating" class="rating rating-loading" data-min="0" data-max="5" data-step="1" data-size="xs" value="0" />

                                        <img id="change-start1" src="/img/star.png">
                                        <img id="change-start2" src="/img/star.png">
                                        <img id="change-start3" src="/img/star.png">
                                        <img id="change-start4" src="/img/star.png">
                                        <img id="change-start5" src="/img/star.png">
                                    </div>
                                </div>
                            </div>
                        </div>
