                    ...
                    <div class="formWrap">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label class="width-102">Beach / Break <span class="mandatory">*</span></label>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="selectWrap pos-rel">
                                            <select class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-4 pl-1 pr-1 col-6">
                                        <div class="cstm-check pos-rel">
                                            <input type="checkbox" id="Floater" />
                                            <label for="Floater" class="">Floater</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4 pl-1 pr-1 col-6">
                                        <div class="cstm-check pos-rel">
