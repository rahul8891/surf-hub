            ...
            <div class="middle-content" id="post-data">
                ...
                <div class="news-feed">
                    <div class="inner-news-feed">
                        ...
                        <div class="newsFeedImgVideo hls-video-player" id="myVid{{$posts->id}}" data-id="{{$posts->id}}" data-src="https://d1d39qm6rlhacy.cloudfront.net/hls/hls/master.m3u8">
                       <video width="100%" preload="auto" data-setup="{}" controls autoplay playsinline muted class="video-js" id="myVideoTag{{$posts->id}}">
                        ...
                        @else
                        <div class="newsFeedImgVideo hls-video-player" id="myVid{{$posts->id}}" data-src="https://d1d39qm6rlhacy.cloudfront.net/hls/hls/master.m3u8">
