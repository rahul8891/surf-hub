    ...
    <div class="container">
        <div class="home-row">
            ...
            <div class="middle-content" id="post-data">
                @if (isset($uploads) && empty($uploads[0]))
                    ...
                    <div class="inner-news-feed">
                        ...
                        <div class="user-bottom-options">
                            ...
                            <div class="right-options">
                                ...
                                <a onclick="openFullscreenSilder({{$posts->id}}, 'surfer-upload');"><img src={{asset("/img/expand.png")}} alt="Expand"></a>
