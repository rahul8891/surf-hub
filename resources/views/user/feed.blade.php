                        ...
                        <div class="user-details">
                            <div class="user-left">
                                ...
                                <div>
                                    ...
                                    @elseif($posts->user->user_type == 'PHOTOGRAPHER')
                                    <p class="name"><span><a href="{{route('photographer-profile', Crypt::encrypt($posts->user_id))}}">{{ (isset($posts->user->user_name) && !empty($posts->user->user_name))?ucfirst($posts->user->user_name):"SurfHub" }} ( <?php echo $icon;?> {{ucfirst($posts->surfer) }} )</a></span> </p>
                                    @elseif($posts->user->user_type == 'SURFER CAMP')
                                    ...
                                    @else
                                    <p class="name"><span>{{ (isset($posts->user->user_name) && !empty($posts->user->user_name))?ucfirst($posts->user->user_name):"SurfHub" }} ( <?php echo $icon;?> {{ucfirst($posts->surfer) }} )</span>
                                    </p>
                                    @endif
...
<input type="hidden" class="popupPagination" value="1">
