                                    ...
                                    <div class="ratingShareWrap">
                                        ...
                                        <div>
                                            <ul class="pl-0 mb-0 d-flex">
                                                <li>
                                                    @if(!empty($postData->upload->image))
                                                    <a target="_blank" href="http://m.facebook.com/sharer/sharer.php?u=<?php echo Request::url(); ?>&amp;p[title]=<?php echo 'Surf Hub';?>&amp;p[desc]=<?php echo $postData->post_text;?>&amp;p[images]=<?php echo url('/').'storage/images/'.$postData->upload->image;?>, 'sharer', 'toolbar=0,status=0,width=548,height=325'"><img src="{{ asset("/img/facebook.png")}}" alt=""></a>
